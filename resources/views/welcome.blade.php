            ...
            <div class="relative h-full  overflow-hidden  ">
                @foreach ($informasi as $item)
                    ...
                    <div class="hidden h-full duration-700 ease-in-out" data-carousel-item>
                        <div class="absolute font-main  w-full z-50 h-full py-12">
                            <div
                                class=" mx-auto flex flex-col justify-end max-w-7xl px-2 sm:px-6 lg:px-8 gap-2 w-full h-full">
                                <h2 class="text-white text-sm md:text-base font-semibold ">Sistem Informasi RW 06 - Kalirejo</h2>
                                <h1 class=" text-xl hidden md:flex font-extrabold text-white w-3/4">
                                    {{ $item->deskripsi_informasi }} </h1>
                                <h1 class=" text-xl block md:hidden font-extrabold text-white w-3/4">{{ $item->judul }} </h1>
