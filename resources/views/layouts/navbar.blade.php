...
<nav class="bg-white py-2">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        <div class="absolute inset-y-0 right-0 flex items-center lg:hidden">
          <!-- Mobile menu button-->
          <button id="mobile-button" type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-neutral-01 bg-dodger-blue-700 hover:bg-dodger-blue-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
        ...
        <div class="flex  flex-1 items-center justify-between sm:items-stretch ">
          ...
          <div id="dropdown" class="z-50 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 drop-shadow-card ">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
              <li>
                <a href="/umkm" class="block px-4 py-2 hover:text-blue-main dark:hover:bg-gray-600 dark:hover:text-white">UMKM</a>
              </li>
              <li>
    ...
    <div class="hidden" data-open="false" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <a href="#" class=" text-blue-main block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Dashboard</a>
        <a href="#" class="text-neutral-10  hover:text-blue-main block rounded-md px-3 py-2 text-base font-medium">Team</a>
        <a href="#" class="text-neutral-10  hover:text-blue-main block rounded-md px-3 py-2 text-base font-medium">Projects</a>
        <a href="#" class="text-neutral-10  hover:text-blue-main block rounded-md px-3 py-2 text-base font-medium">Calendar</a>
      </div>
    </div>
  </nav>
