                ...
                <form class="max-w-sm mx-auto" action="{{ route('tinggal.penduduk.find') }}" method="GET">   
                    ...
                    <div id="statusDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="statusDropdownButton">
                            <li>
                                <a href="{{ route('tinggal.penduduk.index', ['status' => '']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">-Semua-</a>
                            </li>
                            <li>
                                <a href="{{ route('tinggal.penduduk.index', ['status' => 'Selesai']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Selesai</a>
                            </li>
                            <li>
                                <a href="{{ route('tinggal.penduduk.index', ['status' => 'Proses']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Proses</a>
                            </li>
                            <li>
                                <a href="{{ route('tinggal.penduduk.index', ['status' => 'Menunggu']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Menunggu</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <a href="{{ route('tinggal.penduduk.create') }}" class="inline-block text-white bg-blue-main px-4 md:px-8 py-2 md:py-3 font-medium text-sm md:text-base rounded-full shadow-lg md:shadow-xl">Ajukan</a>
            </div>
