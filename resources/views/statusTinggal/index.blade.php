...
@section('content')
    <header class="bg-white">
        <div class="mx-auto max-w-7xl px-8 py-12 sm:px-6 lg:px-8 text-center">
            <h1 class="text-3xl font-extrabold text-neutral-10">Status Tempat Tinggal</h1>
            <p class="mt-6 font-normal leading-6 text-neutral-10 max-w-4xl mx-auto">Formulir ini dirancang untuk warga RW
                04
                Kalirejo yang ingin mengajukan perubahan status tempat tinggal. Melalui formulir ini, warga dapat memberikan
                informasi terkait perubahan status tempat tinggal yang diinginkan, seperti pindah tempat tinggal, perubahan
                alamat, atau perubahan status lainnya.</p>
        </div>
    </header>
    ...
    <div class="bg-white mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="flex flex-wrap justify-end md:justify-between mb-12 gap-3">
            <div class="flex gap-3 z-40 relative justify-between md:justify-normal w-full md:w-[80%] drop-shadow-lg">
                ...
                <form class="w-full md:max-w-md " action="{{ route('tinggal.penduduk.index') }}" method="GET">
                    <div class="relative">
                ...
                <div id="statusDropdown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="statusDropdownButton">
                        <li>
                            <a href="{{ route('tinggal.penduduk.index', ['status' => '']) }}"
            ...
            <a href="{{ route('tinggal.penduduk.create') }}"
