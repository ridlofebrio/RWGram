...
@section('content')
        <header class="bg-white">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 text-left">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-neutral-10">Form Permohonan Ubah Status Meninggal</h1>
                <p class="mt-2 text-base leading-6 text-neutral-10 max-w-xl">Silakan mengisi form permohonan ubah status meninggal dengan benar, ya!</p>
            </div>
        </header>
        ...
        <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="max-w-7xl mx-auto card p-8 mb-12" style="box-shadow: 0 -2px 6px rgba(0, 0, 0, 0.1), 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 10px;">
                <form action="{{ route('hidup.penduduk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="sm:col-span-4">
                        <label for="NIK_meninggal" class="block text-sm font-medium leading-6 text-neutral-10">NIK Orang Yang Meninggal</label>
                        <div class="mt-1 mb-4">
