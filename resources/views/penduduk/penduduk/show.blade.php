...
@section('content')
    <header class="bg-white">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 text-left">
            ...
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Form Data Diri</h1>
            <p class="mt-2 text-base leading-6 text-gray-600 max-w-xl">Silakan melihat data diri Anda, ya!</p>
        </div>                 
    </header>
    <main class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <div class="max-w-7xl mx-auto card p-8 mb-12" style="box-shadow: 0 -2px 6px rgba(0, 0, 0, 0.1), 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 10px;">
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Nomor Identitas Kependudukan</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Tempat Lahir</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Status Kawin</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Golongan Darah</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Agama</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Pekerjaan</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Status Tinggal</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-medium leading-6 text-gray-900">Status Meninggal</label>
                <div class="mt-1 mb-4">
                    <div class="block w-full rounded-md border-0 py-1.5 pl-2 pr-3 
                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset 
