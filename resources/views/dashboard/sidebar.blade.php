<aside id="separator-sidebar"
    ...
    <div class="h-full flex flex-col">
        <div
            class="h-full font-body flex flex-col justify-between text-sm px-6 py-10 overflow-y-auto bg-white dark:bg-gray-800">
            <div class="top">
                <div class="logo">
                ...
                <ul class="mt-12 space-y-3 font-medium">
                    <li>
                        <a href="{{ url('dashboard') }}"
                            class="{{ $active == 'beranda' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }}  flex items-center py-3 px-4 text-black rounded-xl dark:text-white  dark:hover:bg-gray-700 group">
                            @if ($active == 'beranda')
                    ...
                    <li>
                        <a href="{{ url('dashboard/pengajuan') }}"
                            class="flex items-center {{ $active == 'pengajuan' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }}  py-3 px-4 text-black rounded-xl dark:text-white  dark:hover:bg-gray-700 group">
                            @if ($active == 'pengajuan')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="#fff"
                    ...
                    <li>
                        <a href="{{ url('dashboard/pengaduan') }}"
                            class="flex items-center {{ $active == 'pengaduan' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }} py-3 px-4 text-black rounded-xl dark:text-white  dark:hover:bg-gray-700 group ">
                            @if ($active == 'pengaduan')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="#fff"
                ...
                <ul class="pt-4 mt-4 space-y-3 font-medium border-t border-gray-200 dark:border-gray-700">
                    <li>
                        <a href="{{ url('dashboard/penduduk') }}"
                            class="{{ $active == 'penduduk' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }}  flex items-center py-3 px-4 text-black transition duration-75 rounded-xl  dark:hover:bg-gray-700 dark:text-white group">
                            @if ($active == 'penduduk')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="#fff"
                    ...
                    <li>
                        <a href="{{ url('dashboard/bansos') }}"
                            class="{{ $active == 'bansos' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }}  flex items-center py-3 px-4 text-black transition duration-75 rounded-xl  dark:hover:bg-gray-700 dark:text-white group">
                            @if ($active == 'bansos')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="#fff"
                    ...
                    <li>
                        <a href="#"
                            class="{{ $active == 'kas' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }}  flex items-center py-3 px-4 text-black transition duration-75 rounded-xl  dark:hover:bg-gray-700 dark:text-white group">
                            @if ($active == 'kas')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="#fff"
                    ...
                    <li>
                        <a href="#"
                            class="{{ $active == 'persuratan' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }} flex items-center py-3 px-4 text-black transition duration-75 rounded-xl  dark:hover:bg-gray-700 dark:text-white group">
                    ...
                    <li>
                        <a href="#"
                            class="{{ $active == 'akun' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }}  flex items-center py-3 px-4 text-black transition duration-75 rounded-xl  dark:hover:bg-gray-700 dark:text-white group">
                            @if ($active == 'akun')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="#fff"
                    ...
                    <li>
                        <a href="#"
                            class="{{ $active == 'sandi' ? 'bg-blue-main hover:bg-blue-main text-white' : 'hover:bg-gray-100' }}  flex items-center py-3 px-4 text-black transition duration-75 rounded-xl  dark:hover:bg-gray-700 dark:text-white group">
                            @if ($active == 'sandi')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="#fff" d="M13.25 12a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5Z" />
                                    <path fill="#fff"
                            ...
                            @else
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    ...
                                    <path stroke="#1B1B1B" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-miterlimit="10" stroke-width="1.5"
                                        d="M16.28 13.61a4.147 4.147 0 0 1-4.18 1.03l-2.59 2.58c-.18.19-.55.31-.82.27l-1.2-.16c-.4-.05-.76-.43-.82-.82l-.16-1.2c-.04-.26.09-.63.27-.82l2.58-2.58c-.44-1.43-.1-3.05 1.03-4.18 1.62-1.62 4.26-1.62 5.89 0 1.62 1.61 1.62 4.25 0 5.88Zm-5.83 2.67-.85-.86" />
                                    <path stroke="#1B1B1B" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2" d="M13.395 10.7h.008" />
                                </svg>
                            @endif
            ...
            <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="{{ url('logout') }}"
                        class="flex items-center py-3 px-4 text-black rounded-xl dark:text-white  dark:hover:bg-gray-700 group {{ $active == 'logout' ? ' text-white' : 'hover:bg-gray-100' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24">
                            <path stroke="#EE0B0B" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        ...
                        <span class="ms-3 text-[#EE0B0B]">Log Out</span>
 ...
 <aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
   <div class="h-full flex flex-col justify-between">
      <div class="h-full font-body flex flex-col justify-between text-sm px-3 py-10 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
         <li>
            <a href="{{url('logout')}}"  class="flex items-center active:bg-blue-main p-2 text-black rounded-lg dark:text-white  dark:hover:bg-gray-700 group {{$active == 'pengaduan'? "bg-blue-main hover:bg-blue-main text-white":'hover:bg-gray-100'}}" >
              <i class="fa-solid fa-comments text-xl text-black transition duration-75" ></i>
