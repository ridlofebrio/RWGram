...
<div class="h-[100px] bg-white w-full px-5">
    <div class="flex items-center h-full justify-between">
        <h1 class="ml-72 text-xl">{{$i[$num]}} {{date('d F Y',strtotime(now()))}}</h1>
                ...
                <div class="user flex gap-3 items-center">
                    ...
                    <div class="info flex justify-center items-center gap-3">
                        <div class="detail">
                            ...
                            <h2 class="font-body font-medium text-xs text-neutral-400">{{Auth::user()->role_id == 1 ? 'RW Admin' : 'RT Admin'}}</h2>
                        </div>
